...
func TestAdapt(t *testing.T) {
	cases := []struct {
		...
		{"discord", "application/json", `{"content": "Sonarr grabbed something", "username": "Sonarr", "embeds": []}`, "Sonarr grabbed something"},
		{"slack text", "application/json", `{"text": "[FIRING] Disk", "username": "alertmanager", "icon_emoji": ":fire:"}`, "[FIRING] Disk"},
		{"slack attachments", "application/json", `{"attachments": [{"title": "Grafana", "text": "CPU high"}, {"text": "on host b"}]}`, "Grafana\nCPU high\non host b"},
