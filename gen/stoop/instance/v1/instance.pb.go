...
func (x *GetInstanceStatusResponse) GetSessionLifetimeDays() int32 {
	if x != nil {
		return x.SessionLifetimeDays
	}
	return 0
}
...
func (x *UpdateSettingsRequest) GetSessionLifetimeDays() int32 {
	if x != nil && x.SessionLifetimeDays != nil {
		return *x.SessionLifetimeDays
	}
	return 0
}
...
const file_stoop_instance_v1_instance_proto_rawDesc = "" +
	...
	"\x10ClearUserProfile\x12*.stoop.instance.v1.ClearUserProfileRequest\x1a+.stoop.instance.v1.ClearUserProfileResponse\"\x00\x12p\n" +
	"\x11TransferOwnership\x12+.stoop.instance.v1.TransferOwnershipRequest\x1a,.stoop.instance.v1.TransferOwnershipResponse\"\x00\x12j\n" +
