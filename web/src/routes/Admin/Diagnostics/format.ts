...
// The tab's two clocks (how long the server has been up, how long ago
// something was read), the Requests panel's durations, and the words of
// the Background work table.
